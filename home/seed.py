...
def seed_db(n=10)-> None:
    try:
        for _ in range(n):
            ...
            student_obj=Student.objects.create(student_id=student_id_obj,department=department,student_name=student_name,student_email=student_email,student_age=student_age,student_address=student_address)
